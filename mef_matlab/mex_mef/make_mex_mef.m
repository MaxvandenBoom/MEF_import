...
mex -output read_mef_header_mex_3p0 ...
    ...
    matmef/meflib/meflib/meflib.c ...
    matmef/meflib/meflib/mefrec.c ...
...
mex -output read_mef_session_metadata read_mef_session_metadata.c ...
    meflib/meflib/meflib.c meflib/meflib/mefrec.c matmef_mapping.c ...
    mex_datahelper.c

fprintf('\n')
fprintf('Building read_mef_ts_data.mex*\n')
mex -output read_mef_ts_data read_mef_ts_data.c matmef_data.c ...
    meflib/meflib/meflib.c meflib/meflib/mefrec.c
