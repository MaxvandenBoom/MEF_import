...
% MEFSESSION_2P1.checkSessValid check validation of session data
% 
% Syntax:
...
% check requirement of subject encryption 
...
% check requirement of session encryption 
...
% check requirement of data encryption 
